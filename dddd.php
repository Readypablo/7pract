...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($errors)) {
        ...
        // Если все ограничения выполнены, выполняем нужный код
        echo "Пароль принят!";
    }
...
<form  method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
  ...
  <input type="text" id="username" name="username" minlength="4" maxlength="20" pattern="[а-яА-Я]+" required>
  <br>
  ...
  <input type="email" id="email" name="email" minlength="5" maxlength="100" required>
  <br>

  <label for="phone">Номер телефона:</label>
  <input type="number" id="phone" name="phone" minlength="8" maxlength="15" required>
  <br>

  <label for="address">Адрес доставки:</label>
  <input type="вфеф" id="address" name="address" minlength="10" maxlength="100" required>
  <br>
